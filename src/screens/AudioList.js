...
import AudioListItem from '../components/AudioLisItem';
...
export class AudioList extends Component {
    ...
    handleAudioPress = async audio => {
        ...
        if(soundObj === null){
            ...
            updateState(this.context, {currentAudio: audio, playbackObject: playbackObject, soundObj: status, isPlaying: true, currentAudioIndex: index});
                ...
                {({dataProvider, isPlaying}) => {
                    ...
                    return (
                        <Screen>
                            ...
                            onPlaylistPress={() => this.context.updateState(this.context, {
